...
from tgbot.handlers.user_message import (user_text_message, user_media_message, message_is_too_long, user_is_banned)
...
def register_handlers():
    ...
    bot.register_message_handler(user_text_message, content_types = ['text'], pass_bot = True, admin = False,
                                 length = int(config['MAX_MESSAGE_LENGTH']), banned = False
                                 )

    bot.register_message_handler(user_media_message, content_types = MEDIA, pass_bot = True, admin = False,
                                 length = int(config['MAX_CAPTION']), banned = False)

    bot.register_message_handler(message_is_too_long, content_types = TEXT_MEDIA, pass_bot = True, admin = False,
                                 banned = False
                                 )

    bot.register_message_handler(user_is_banned, content_types = TEXT_MEDIA, pass_bot = True, admin = False,
                                 banned = True
                                 )
